...
(14, 'DT 1770 PRO', 'beyerdynamic_5.jpg', NULL, 'beyerdynamic', '耳罩式耳機', 17970, 1170, 521, 5, 0, '這些基准設定的封閉式錄音室耳機結合了數十年的耳機生產專業知識和最新的Tesla驅動技術。除了高分辨率和均衡的聲音外，beyerdynamic DT 1770 PRO耳機還樹立了新標準，尤其是在舒適性和工藝上。', '2020-04-22 15:44:00', '2020-04-30 16:10:48'),
...
(21, 'Beoplay H4 2nd Gen1', 'item_20200430100532.png', NULL, 'william', 'william', 100, 10, 1, 1, NULL, 'q', '2020-04-30 16:05:32', '2020-04-30 16:10:40'),
(22, 'apple耳機2', 'item_20200430101149.jpg', 6, 'qweqweqw', 'william', 1000, 111, 1, 1, NULL, 'test', '2020-04-30 16:11:49', '2020-04-30 16:11:49');
...
--
ALTER TABLE `items`
  MODIFY `itemId` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水號', AUTO_INCREMENT=23;

--
-- 使用表AUTO_INCREMENT `items_color`
--
ALTER TABLE `items_color`
  MODIFY `coid` tinyint(20) NOT NULL AUTO_INCREMENT COMMENT '顏色號碼', AUTO_INCREMENT=9;
