...
CREATE TABLE `items` (
  ...
  `itemsstar` int(5) NOT NULL COMMENT '產品評分',
...
(16, 'apple耳機2', 'item_20200427140817.png', 0, 'william', 'william', 1000, 12, 1, 0, 0, 'asdadasdasdasdasda', '2020-04-27 20:08:17', '2020-04-27 20:08:17');
