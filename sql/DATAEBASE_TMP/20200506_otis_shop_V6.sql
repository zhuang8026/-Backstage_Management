...
--
-- Host: localhost:8889
-- Generation Time: May 05, 2020 at 04:27 PM
...
(59, 'ATH-S100iS_BBL', 'ATH-S100iS_BBL_550.jpg', 5, 'audio-technica', '1', 1200, 56, 123, 4, 0, '最適合上街使用的單邊出線風格 可體驗通話與操作樂趣的智慧型手機支援機種', '2020-06-01 23:14:00', '2020-05-05 23:22:54'),
...
--
ALTER TABLE `stores`
  MODIFY `storeId` int(11) NOT NULL AUTO_INCREMENT COMMENT '商場編號', AUTO_INCREMENT=16;
